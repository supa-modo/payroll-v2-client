...
const EmployeesPage: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="font-source bg-white rounded-3xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="px-5 pt-5 flex items-center gap-2 border-b border-gray-200 space-y-4">
