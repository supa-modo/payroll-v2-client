      ...
      <div className={clsx("w-full", wrapperClassName)}>
        {label && (
          <div className="flex items-center justify-between">
            ...
            {rightLabelButtonText && (
              <Link to={rightLabelButtonText.href} className="text-[0.83rem] font-medium pr-1.5 text-blue-600 hover:text-blue-700 transition-colors">
        ...
        <div className="relative">
          ...
          <input
            ...
            type={type || "text"}
            className={clsx(
              "w-full px-4 py-2.5 rounded-[0.7rem] border transition-all duration-200 text-[0.9rem]",
