      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <div className={`${config.bgColor} px-5 pb-4 pt-3 flex flex-col-reverse sm:flex-row gap-2 sm:gap-3 justify-end`}>
              {(showCancel || type === "confirm" || type === "delete") && (
                <button
                  type="button"
                  onClick={handleCancel}
                  className="w-full flex justify-center px-4 py-2.5 text-sm font-semibold text-slate-700 border border-gray-400 hover:bg-slate-100 rounded-full transition-colors"
                >
                  {cancelText}
                </button>
              )}
              <button
                ...
                className={`w-full flex justify-center px-4 py-2.5 text-sm font-semibold text-white rounded-full transition-colors ${config.primaryButton}`}
              >
